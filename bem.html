...
<html lang="id">
  <head>
    ...
    <title>BEM Mahatar - Kemahataran AMNI</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <main class="news-container">
      <div class="header-section">
        <h1 class="header-title">Badan Eksekutif Mahasiswa (BEM) Mahatar</h1>
        <p class="header-subtitle">
          Wadah aspirasi, kepemimpinan, dan penggerak utama kegiatan
          kemahasiswaan Kemahataran AMNI
        </p>
        <hr class="divider" />
      </div>
        ...
        >
          ...
          <div style="flex: 1; min-width: 280px">
            ...
            <p
              ...
              "
            >
              BEM Kemahataran AMNI merupakan lembaga eksekutif tertinggi di
              tingkat mahasiswa yang bertugas mengintegrasikan seluruh kegiatan
              ekstrakurikuler, menyalurkan aspirasi taruna/i, serta mengabdi
              kepada masyarakat.
            </p>
            <ul
            ...
            >
              <li style="margin-bottom: 8px">
                ...
                ></i>
                <strong>Pembina:</strong> Tim Pengasuh Kemahataran
              </li>
              <li style="margin-bottom: 8px">
                <i
                  ...
                  style="color: var(--accent-cyan); width: 25px"
                ></i>
                <strong>Jadwal Rutin:</strong> Rapat Mingguan & Evaluasi Bulanan
              </li>
              <li style="margin-bottom: 8px">
                <i
                  ...
                  style="color: var(--accent-cyan); width: 25px"
                ></i>
                <strong>Lokasi Sekretariat:</strong> Gedung Kemahataran AMNI
              </li>
            </ul>
          </div>
        </div>
        ...
        >
          ...
          >
            <h4 style="color: var(--accent-cyan); margin-bottom: 8px">
              1. Latihan Kepemimpinan Taruna
            </h4>
            <p style="font-size: 0.88rem; color: var(--text-secondary)">
              Pelatihan kedisiplinan dan manajemen keorganisasian untuk calon
              pengurus baru.
            </p>
          </div>
          <div
          ...
          >
            ...
            <p style="font-size: 0.88rem; color: var(--text-secondary)">
              Aksi sosial berkala di wilayah pesisir Semarang dan sekitarnya.
            </p>
          </div>
        </div>
      </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px">
          ...
          >
            <span style="font-size: 0.8rem; color: var(--accent-cyan)"
              ><i class="fa-solid fa-calendar"></i> 10 Agustus 2026</span
            >
            <h4 style="margin: 5px 0; color: var(--text-primary)">
              Pelantikan Pengurus BEM Mahatar Periode 2026/2027
            </h4>
            <p
              style="
                font-size: 0.85rem;
              ...
              "
            >
              Pelantikan resmi pengurus BEM baru dipimpin langsung oleh Wakil
              Direktur III Kemahataran AMNI.
            </p>
          </div>
        </div>
      </div>
