...
<head>
    ...
    <title>Kelola Kegiatan - Mahatar AMNI</title>
      ...
      <div class="header-actions">
        <div>
          <h1
            ...
            "
          >
            Kelola Kegiatan Mahasiswa
          </h1>
          <p style="color: var(--text-secondary); font-size: 0.9rem">
            Selamat datang di halaman pengelolaan kegiatan mahasiswa Mahatar AMNI.
          </p>
        </div>
     ...
     <div class="table-responsive">
        ...
        <thead>
            <tr>
              ...
              <th>Tanggal Kegiatan Di Upload</th>
...
<tbotbody>
            <?php $no = 1; if (mysqli_num_rows($result) > 0) : while ($kegiatan =
            ...
            <tr>
              ...
              <td>
                <?= htmlspecialchars( mb_strimwidth(strip_tags($kegiatan['isi']),
                                    0,
                                    50,
                                    "..."
                                    )
