        ...
        <div style="display: flex; flex-direction: column; gap: 12px">
          ...
          >
            <span style="font-size: 0.8rem; color: var(--accent-cyan)"
              ><i class="fa-solid fa-calendar"></i> 25 Juli 2026</span
            >
            <h4 style="margin: 5px 0; color: var(--text-primary)">
              Pengawalan Sakral Wisuda Perwira Pelayaran Niaga XLV
            </h4>
            <p
              style="
                font-size: 0.85rem;
              ...
              "
            >
              Tim Pedang Pora sukses mengawal jajar kehormatan pelepasan lulusan
              perwira AMNI.
            </p>
          </div>
        </div>
