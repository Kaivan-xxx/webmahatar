...
<html lang="id">
  <head>
    ...
    <title>Zenkyokushin - Kemahataran AMNI</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <main class="news-container">
      <div class="header-section">
        <h1 class="header-title">Karate Zenkyokushin AMNI</h1>
        <p class="header-subtitle">
          Seni beladiri kontak penuh untuk membentuk fisik tangguh dan
          mentalitas baja
        </p>
        <hr class="divider" />
      </div>
        ...
        >
          ...
          <div style="flex: 1; min-width: 280px">
            ...
            <p
              ...
              "
            >
              Aliran karate kontak penuh (full contact) yang melatih ketahanan
              stamina, pertahanan diri praktis, serta kerendahan hati. Menjadi
              modal berharga bagi calon perwira yang berlayar di samudra.
            </p>
            <ul
            ...
            >
              <li style="margin-bottom: 8px">
                ...
                ></i>
                <strong>Fokus Pembinaan:</strong> Kata, Kumite, & Conditioning
                Fisik
              </li>
              <li style="margin-bottom: 8px">
                <i
                  ...
                  style="color: var(--accent-cyan); width: 25px"
                ></i>
                <strong>Jadwal Latihan:</strong> Senin & Jumat (16.00 WIB)
              </li>
              <li style="margin-bottom: 8px">
                <i
                  ...
                  style="color: var(--accent-cyan); width: 25px"
                ></i>
                <strong>Lokasi Latihan:</strong> Dojo Kemahataran AMNI
              </li>
            </ul>
          </div>
        </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px">
          ...
          >
            <span style="font-size: 0.8rem; color: var(--accent-cyan)"
              ><i class="fa-solid fa-calendar"></i> 14 Juni 2026</span
            >
            <h4 style="margin: 5px 0; color: var(--text-primary)">
              Ujian Kenaikan Tingkat & Gashuku Karate AMNI
            </h4>
            <p
              style="
                font-size: 0.85rem;
              ...
              "
            >
              Puluhan kohai taruna berhasil menyelesaikan ujian fisik dan teknik
              sabuk di Pantai Marina.
            </p>
          </div>
        </div>
      </div>
