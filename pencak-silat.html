...
<html lang="id">
  <head>
    ...
    <title>Pencak Silat - Kemahataran AMNI</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <main class="news-container">
      <div class="header-section">
        <h1 class="header-title">Unit Kegiatan Pencak Silat</h1>
        <p class="header-subtitle">
          Pelestarian seni beladiri warisan budaya bangsa yang membentuk
          kepribadian mulia
        </p>
        <hr class="divider" />
      </div>
        ...
        >
          ...
          <div style="flex: 1; min-width: 280px">
            ...
            <p
              ...
              "
            >
              Mengintegrasikan elemen olahraga, seni jurus, beladiri, dan
              mental-spiritual. Melatih kecerdasan reflek serta ketangkasan
              gerak fisik bagi taruna/i.
            </p>
            <ul
            ...
            >
              <li style="margin-bottom: 8px">
                ...
                ></i>
                <strong>Kategori:</strong> Tanding (Laga) & Seni Tunggal/Ganda
              </li>
              <li style="margin-bottom: 8px">
                <i
                  ...
                  style="color: var(--accent-cyan); width: 25px"
                ></i>
                <strong>Jadwal Latihan:</strong> Rabu & Sabtu Sore
              </li>
              <li style="margin-bottom: 8px">
                <i
                  ...
                  style="color: var(--accent-cyan); width: 25px"
                ></i>
                <strong>Lokasi Latihan:</strong> Areal Serbaguna Kemahataran
              </li>
            </ul>
          </div>
        </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 12px">
          ...
          >
            <span style="font-size: 0.8rem; color: var(--accent-cyan)"
              ><i class="fa-solid fa-calendar"></i> 20 Maret 2026</span
            >
            <h4 style="margin: 5px 0; color: var(--text-primary)">
              Raihan Medali Emas Kejuaraan Silat Antar Perguruan Tinggi
            </h4>
            <p
              style="
                font-size: 0.85rem;
              ...
              "
            >
              Kontingen Pencak Silat AMNI menyabet 2 medali emas pada ajang
              pencak silat tingkat regional Jawa Tengah.
            </p>
          </div>
        </div>
      </div>
